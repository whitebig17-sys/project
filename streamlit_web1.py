...
with col1:
    st.markdown(
        "<p style='font-size:24px;'>預防肺癌與護肺要點</p>",
        unsafe_allow_html=True
    )
    st.markdown(
        "<p style='font-size:14px;'>5大肺癌預防與護肺要點"
...
with col2:
    st.markdown(
        "<p style='font-size:24px;'>治療肺癌與護肺要點</p>",
        unsafe_allow_html=True
    )
...
with c1:
    st.write(
        "5大肺癌預防與護肺要點"
        "戒菸與遠離菸害：吸菸是導致肺癌最大的危險因子，"
        "吸菸者及經常接觸二手菸、三手菸的民眾風險大增，"
        "應盡早戒菸並拒絕菸害。"
        "減少廚房油煙：高溫煎、炒容易產生有害油煙。"
        "烹調時建議多用蒸、煮或低溫水炒，務必開啟抽油煙機，"
        "並保持廚房通風。"
